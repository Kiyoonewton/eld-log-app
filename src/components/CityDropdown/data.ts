// 50 Mock Location Suggestions
// You can use these in your fetchLocationSuggestions function

export const generateMockSuggestions = (query: string): string[] => {
    const locations = [
    ...
    // Return filtered locations based on the query
    return locations.filter(location => 
      query === '' || location.toLowerCase().includes(query.toLowerCase())
    ).slice(0, 10); // Return top 10 matches
  };
  
  // Example usage:
  // const suggestions = generateMockSuggestions("New York");