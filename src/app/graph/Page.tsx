...
import Graphpage from "@/app/graph/GraphComponent";
import React, { useState } from "react";
import { GraphSheet } from "../types";

interface EldLogDisplayProps {
  logs: GraphSheet[];
}

const GraphPage: React.FC<EldLogDisplayProps> = ({ logs }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      {currentLog && <Graphpage logs={currentLog} />}
    </div>
  );
};
